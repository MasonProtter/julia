...
JL_DLLEXPORT jl_value_t *jl_rettype_inferred_within(jl_method_instance_t *li JL_PROPAGATES_ROOT, size_t min_world, size_t max_world, jl_value_t* compilerplugin);
