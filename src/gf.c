...
JL_DLLEXPORT jl_value_t *jl_rettype_inferred_within(jl_method_instance_t *mi, size_t min_world, size_t max_world, jl_value_t *compilerplugin) JL_NOTSAFEPOINT
{
        ...
        size_t min_world, size_t max_world)
{
    ...
    while (codeinst) {
        if (codeinst->min_world == min_world &&
            ...
            jl_egal(codeinst->compilerplugin, compilerplugin) &&
    ...
    codeinst = jl_new_codeinst(
        mi, compilerplugin, rettype, NULL, NULL,
        ...
        /*, jl_array_t *edges, int absolute_max*/)
{
    ...
    codeinst->def = mi;
    codeinst->compilerplugin = compilerplugin;
