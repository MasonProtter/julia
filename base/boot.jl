...
function CodeInstance(
    mi::MethodInstance, compilerplugin, @nospecialize(rettype), @nospecialize(inferred_const),
    ...
    return ccall(:jl_new_codeinst, Ref{CodeInstance},
        ...
        mi, compilerplugin, rettype, inferred_const, inferred, const_flags, min_world, max_world,
